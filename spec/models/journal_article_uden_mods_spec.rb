...
describe JournalArticle do
  ...
  it "should have the specified datastreams" do
    ...
    # Check for descMetadata datastream with ModelMixin in it
    @article.datastreams.keys.should include("DublinCore")
    @article.descMetadata.should be_kind_of Hydra::ModelMixins::DcDatastream



    # Check for descMetadata datastream with ModelMixin in it
    @article.datastreams.keys.should include("descMetadata")
    @article.descMetadata.should be_kind_of Hydra::ModelMixins::CommonMetadata
